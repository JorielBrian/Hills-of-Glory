<x-layouts.homepage>
    ...
    <div class="px-10 h-screen">
        ...
        <div class="flex w-1/2 p-20 mt-50">
            <div>
                <h1 class="text-3xl py-3 text-white font-[Century Gothic] font-bold">Announcements</h1>
            ...
            <div>
                <h1 class="text-3xl py-3 text-white font-[Century Gothic] font-bold">Upcoming Events</h1>
