<x-layout>
    ...
    <div class="px-10">
        ...
        <div>
            <h2 class="h-fit text-4xl text-[#fdc53a] px-10">Who are able to discple multitudes</h2>
        </div>
        <div class="flex w-1/2 p-20 mt-50">
            <div>
                <h1 class="text-3xl py-3 text-[#6b8b7a] font-[Century Gothic] font-bold">Announcements</h1>
            ...
            <div class="border border-white ml-5 mr-15"></div>
            <div>
                <h1 class="text-3xl py-3 text-[#6b8b7a] font-[Century Gothic] font-bold">Upcoming Events</h1>
