        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <form wire:submit.prevent="save" class="space-y-6" enctype="multipart/form-data">
                ...
                <div class="bg-gray-50 p-6 rounded-lg">
                    ...
                    <!-- Member Photo -->
                    <div class="mb-6">
                        <label for="member_photo" class="block text-sm font-medium text-gray-700">Member Photo</label>
                        <input type="file" wire:model="member_photo" id="member_photo" accept="image/*"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        @error('member_photo') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        <p class="mt-1 text-sm text-gray-500">Upload a photo for the member (optional, max 2MB)</p>
                        ...
                        @if ($member_photo)
                            <div class="mt-4">
                                ...
                                <div class="border border-gray-300 rounded-md p-4 bg-white">
                                    <img src="{{ $member_photo->temporaryUrl() }}" 
